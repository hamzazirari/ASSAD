...
id INT AUTO_INCREMENT PRIMARY KEY, 
idvisitesguides_commentaire INT, 
idutilisateur_commentaire INT, 
note INT, 
texte TEXT, 
date_commentaire DATETIME,
FOREIGN KEY (idvisitesguides_commentaire) REFERENCES visitesguidees(id_visite),
FOREIGN KEY (idutilisateur_commentaire) REFERENCES utilisateurs(id_utilisateur)
);